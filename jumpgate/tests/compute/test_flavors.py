...
class TestFlavorList(unittest.TestCase):
    ...
    def test_on_get_for_flavor_list(self):
        ...
        self.assertEqual(list(self.resp.body.keys()), ['flavors'])
        self.assertEqual(len(self.resp.body['flavors']), 5)
    ...
    def test_on_get_for_flavor_list_marker(self):
        ...
        self.assertEqual(len(self.resp.body['flavors']), 2)
    ...
    def test_on_get_for_flavor_list_minDisk(self):
        ...
        self.assertEqual(len(self.resp.body['flavors']), 4)
    ...
    def test_on_get_flavor_list_missing_id(self):
        ...
        self.assertEqual(list(self.resp.body.keys()), ['flavors'])
        self.assertEqual(len(self.resp.body['flavors']), 1)
...
class TestFlavorV2(unittest.TestCase):
    ...
    def test_on_get(self):
        ...
        self.assertEqual(list(self.resp.body.keys()), ['flavor'])
        ...
        self.assertEqual(set(self.resp.body['flavor'].keys()),
